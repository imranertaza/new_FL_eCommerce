                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <a href="<?php echo base_url('cache_image_remove') ?>" class="btn btn-info btn-sm ">Cache Image Remove</a>
                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                <div class="card-header p-0 border-bottom-0">
                                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="custom-tabs-ai-tab" data-toggle="pill" href="#custom-tabs-ai" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Artificial Intelligence</a>
                                        </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="custom-tabs-four-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-ai" role="tabpanel" aria-labelledby="custom-tabs-ai-tab">
                                            <div class="row">
                                                <!-- Gemini API Key -->
                                                <div class="col-md-6">
                                                    <div class="form-group">
