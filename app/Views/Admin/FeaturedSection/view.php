                                    ...
                                    <div class="form-group" id="brand_<?= $key . '_1' ?>" <?= $hasBrand ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                        ...
                                        <select name="brand_id[]" class="select2Brand" multiple="multiple" style="width: 100%;">
                                            ...
                                            <?php foreach (get_array_data_by_id('cc_brand', 'status', 'Active') as $brand) { ?>
                                                <option value="<?php echo $brand->brand_id; ?>" <?php foreach ($products as $brands) {
                                                                                                    echo ($brands->brand_id == $brand->brand_id) ? 'selected ' : '';
                                    ...
                                    <div class="form-group " id="category_<?= $key . '_1' ?>" <?= $hasCategory ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                        ...
                                        <select name="prod_cat_id[]" class="select2Category" multiple="multiple" style="width: 100%;">
                                            ...
                                            <?php foreach (get_array_data_by_id('cc_product_category', 'status', '1') as $cat) { ?>
                                                <option value="<?php echo $cat->prod_cat_id; ?>" <?php foreach ($products as $val) {
                                    ...
                                    <div class="form-group " id="qcpicture_<?= $key . '_1' ?>" <?= $hasQcPic ? 'style="display:block;"' : 'style="display:none;"' ?>>
                                        ...
                                        <select class="select2QcPicture" name="album_id[]" multiple="multiple" style="width: 100%;">
                                            <?php foreach (get_array_data_by_id('cc_album', 'is_album_uploadable', '1') as $album) { ?>
                                                <option value="<?= $album->album_id; ?>" <?php foreach ($products as $val) {
                                                                                                echo ($val->album_id == $album->album_id) ? 'selected ' : '';
                                                                                            } ?>><?= $album->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
