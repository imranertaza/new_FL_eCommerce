...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>OIS Bizcraft Settings</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard')?>">Home</a></li>
                        <li class="breadcrumb-item active">OIS Bizcraft Settings</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title">OIS Bizcraft Settings</h3>
                    </div>
            ...
            <div class="card-body">
                <form action="<?php echo base_url('oisbizcraft_update_action')?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <?php foreach ($payment_settings as $val){ ?>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="label[]" rows="4" class="form-control"  required><?php echo $val->value;?></textarea>
