    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> Zone Based Offer create</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin_dashboard')?>">Home</a></li>
                            <li class="breadcrumb-item active">Zone Based Offer create</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h3 class="card-title">Zone Based Offer create</h3>
                        </div>
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('zone_based_offer_create_action')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group 	">
                                    ...
                                    <div class="form-group " >
                                        ...
                                        <div class="form-check form-check-inline" >
                                            <input class="form-check-input" type="radio" checked  name="dis_<?php echo $zone->geo_zone_id;?>" id="discountType1_<?php echo $zone->geo_zone_id;?>"  value="discount_percent">
                                            <label class="form-check-label" for="discountType1_<?php echo $zone->geo_zone_id;?>">Percent</label>
                                        </div>
                                        <div class="form-check form-check-inline" >
                                            <input class="form-check-input" type="radio" name="dis_<?php echo $zone->geo_zone_id;?>" id="discountType2_<?php echo $zone->geo_zone_id;?>" value="discount_amount">
                                            <label class="form-check-label" for="discountType2_<?php echo $zone->geo_zone_id;?>">Flat rate</label>
                                        </div>
                                    </div>
                                    <div class="form-group"  >
                                        <label>Amount</label>
                                        <input type="number" name="amount_<?php echo $zone->geo_zone_id;?>" class="form-control" placeholder="Amount" >
                                    </div>
                                </div>
                                <?php } ?>
