                            ...
                            <tbody id="tbody">
                                ...
                                <tr id="update_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_name row_show " id="reNameUpdate_<?php echo $val->product_id?>">
                                        <p  onclick="updateFunction('<?php echo $val->product_id; ?>','name','<?php echo $val->name; ?>','view_name_<?php echo $val->product_id; ?>','bulkForm_name_<?php echo $val->product_id; ?>','reNameUpdate_<?php echo $val->product_id?>')">
