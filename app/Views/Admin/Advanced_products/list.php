                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <form id="multiActionForm" action="<?= base_url('bulk_product_multi_delete')?>" method="post">
                                ...
                                <?php } ?>
                                <?php if(modules_key_by_access('bulk_description_updater') == '1' ){ ?>
                                    <button type="submit" formaction="<?php echo base_url('bulk_description_updater'); ?>" class="btn btn-primary btn-xs float-right mr-2 mb-2"><i class="fas fa-edit"></i> Description Updater</button>
                                <?php } ?>
                            </form>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr id="update_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_name row_show " id="reNameUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_model row_show " id="reModelUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_quantity row_show " id="reQuantityUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_price row_show" id="rePriceUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_meta_title row_hide" id="reMetaTitleUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_meta_keyword row_hide" id="reMetaKeywordUpdate_<?php echo $val->product_id?>">
                                    ...
                                    <td class="colum_meta_description row_hide" id="reMetaDescriptionUpdate_<?php echo $val->product_id?>">
...
<script>
    ...
    function updateFunction(proId, input, value, viewId, formName,updateRow) {
        ...
        var data = '<form id="' + formName +
            '" action="<?php echo base_url('bulk_data_update') ?>" onkeydown="if(event.keyCode === 13) {return false;}" data-row="'+updateRow+'" method="post"><?= csrf_field() ?><input type="text" name="' +
            input +
    ...
    function descriptionTableDataUpdateFunction(proId, input, value, viewId, formName,updateRow) {
        var formID = "'" + formName + "'"
        var data = '<form id="' + formName +
            '" action="<?php echo base_url('description_data_update') ?>" onkeydown="if(event.keyCode === 13) {return false;}" data-row="'+updateRow+'" method="post"><?= csrf_field() ?><input type="text" name="' +
            input +
            '" class="form-control mb-2" value="' + value +
