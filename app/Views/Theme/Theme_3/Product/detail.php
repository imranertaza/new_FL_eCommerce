...
<div class="main-container">
    <div class="container">
            ...
            <div class=" p-3  mb-4 border-bottom">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3">
                        <?php if (is_exists('cc_product_free_delivery', 'product_id', $products->product_id) == false){ ?>
                        ...
                        <table class="table table-borderless  mt-3">
                            <tr>
                                <td class="td-pd">
                                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 100 100" width="24" viewBox="0 0 100 100" id="credit-card">
                                        <path d="M43.9 52.6H16.6c-.6 0-1-.4-1-1s.4-1 1-1h27.3c.6 0 1 .4 1 1S44.5 52.6 43.9 52.6zM54.2 66.7H16.6c-.6 0-1-.4-1-1s.4-1 1-1h37.6c.6 0 1 .4 1 1S54.8 66.7 54.2 66.7zM50.3 45.4H16.6c-.6 0-1-.4-1-1s.4-1 1-1h33.7c.6 0 1 .4 1 1S50.9 45.4 50.3 45.4z"></path><circle cx="63" cy="68.1" r="4.1"></circle><circle cx="69.4" cy="68.1" r="4.1"></circle><path d="M32.2 76.1H16.6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h15.5c.3 0 .5.2.5.5S32.4 76.1 32.2 76.1zM69.5 54.4h-5.4c-1.4 0-2.5-1.1-2.5-2.5v-5.4c0-1.4 1.1-2.5 2.5-2.5h5.4c1.4 0 2.5 1.1 2.5 2.5v5.4C72.1 53.3 70.9 54.4 69.5 54.4zM64.1 44.9c-.8 0-1.5.7-1.5 1.5v5.4c0 .8.7 1.5 1.5 1.5h5.4c.8 0 1.5-.7 1.5-1.5v-5.4c0-.8-.7-1.5-1.5-1.5H64.1z"></path><path d="M90.9,60.9l-4-32.5c-0.5-4-4.2-6.9-8.2-6.4l-57.4,7.1c-2,0.2-3.7,1.2-4.9,2.8c-1.1,1.5-1.7,3.3-1.5,5.1
		...
		C89.3,64.1,87.2,66.8,84.3,67.2z"></path></svg>
                            ...
                            <tr>
                                <td class="td-pd">
                                    <a target="_blank" href="https://wa.me/<?php echo get_model_settings_value_by_modelId_or_label($modulId, 'whatsapp_number');?>" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none">
                                        <path
                                ...
                                <td class="td-pd">
                                    <a target="_blank" class="text-black" href="https://wa.me/<?php echo get_model_settings_value_by_modelId_or_label($modulId, 'whatsapp_number');?>" >Contact us</a>
                                </td>
                            </tr>
                        </table>
                    </div>
