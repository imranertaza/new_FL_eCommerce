                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 px-5">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" name="firstname" id="fname1" class="form-control in_err" placeholder="First Name" value="<?php echo $customer->firstname?>" required>
                                <span class="text-danger err d-inline-block text-capitalize" id="fnameError"></span>
                            </div>

                            <div class="form-group mt-4">
                                <label>Last Name</label>
                                <input type="text" name="lastname" id="lname1" class="form-control in_err" placeholder="Last Name" value="<?php echo $customer->lastname?>" required>
                                <span class="text-danger err d-inline-block text-capitalize " id="lnameError"></span>
                            </div>

                            <div class="form-group mt-4">
                                <label>Email</label>
                                <input type="email" name="email" id="email" class="form-control in_err" placeholder="Email" value="<?php echo $customer->email?>" required>
                        ...
                        <div class="col-md-6 px-5">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <select name="country_id" id="countryName1" class="form-control in_err"  onchange="selectState(this.value,'stateView')" required>
