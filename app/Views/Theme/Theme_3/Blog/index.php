                    ...
                    <div class="col-md-6 mt-4 div-pad">
                        <div class="row class-border">
                            <div class="col-md-5 col-sm-12 position-relative mob-view-img">
                                ...
                                <img data-sizes="auto"  id="" src="<?php echo common_image_view('uploads/blog', $val->blog_id, $val->image, 'noimage.png', '214', '220');?>" alt="<?php echo $val->alt_name?>" class="img-fluid img-redu" loading="lazy">
