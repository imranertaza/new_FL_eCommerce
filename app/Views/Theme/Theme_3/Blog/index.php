                    ...
                    <div class="col-md-6 mt-4">
                        <div class="row ">
                            <div class="col-md-5 position-relative">
                                <?php echo common_image_view('uploads/blog', $val->blog_id, $val->image, 'noimage.png', 'img-fluid ', '', '214', '220');?>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="top d-flex border-bottom pb-2">
                                    <div>
                                        ...
                                        <?php echo get_data_by_id('name','cc_users','user_id',$val->createdBy);?>
                                    </div>
                                    <div class="ms-4 ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                                        ...
                                        (<?php echo count_comment_by_blog_id($val->blog_id);?>) Comments
                                    </div>
                                </div>
                                <div class="title-b">
                                    <p class="b-title"><?php echo $val->blog_title;?></p>
                                    <p class="b-text mt-2"><?php echo substr_replace($val->short_des, "...", 160);?></p>
