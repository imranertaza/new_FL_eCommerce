...
//    }
    /**
     * @description This function provides have access
     * @param int $roleId
    ...
    /**
     * @description This function provides module permission list
     * @param int $role_id
     * @param string $module_name
     * @return mixed
     */
