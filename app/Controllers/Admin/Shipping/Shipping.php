...
//                $check = is_exists('cc_weight_shipping_settings','settings_id',$weight_id[$key]);
    ...
    public function remove_settings_weight(){
        ...
        print '<div class="alert alert-success alert-dismissible" role="alert">Remove Settings Delete Success <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
    }
